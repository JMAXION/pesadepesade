...
import "../css/serviceterm.css";

export default function PrivatePolicy() {
  return (
    <div>
      <SubTitle title="Private Policy" />
      <ul className="privatepolicy">
        <ul>
          <p>
            (주)티비엘 코퍼레이션은 (이하 "회사"는) 고객님의 개인정보를
        ...
        <ul>
          ...
          <p>
            - 회원가입시 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택
            전화번호 , 휴대전화번호 , 이메일 , 14세미만 가입자의 경우
            법정대리인의 정보
          </p>
          <p>- 서비스 신청시 : 주소, 결제 정보</p>

          <p>
            o 서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그,
        ...
        <ul>
          ...
          <p>o 위탁 대상자 : CJ 대한통운㈜</p>

          <p>o 위탁업무 내용 : 물품배송 또는 청구지 등 발송</p>

          <p>o 위탁 대상자 : 카페24㈜</p>

          <p>o 위탁업무 내용 : 개인정보 보관 및 관리, 주문 수집</p>
        ...
        <ul>
          ...
          <p>
            o 이용자들의 개인정보 조회,수정을 위해서는 "개인정보변경"(또는
            "회원정보수정" 등)을 가입해지(동의철회)를 위해서는 "회원탈퇴"를
            클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가
            가능합니다.
          </p>
          <p>
            o 혹은 개인정보보호책임자에게 서면, 전화 또는 이메일로 연락하시면
            지체없이 조치하겠습니다.
          </p>
          <p>
        ...
        <ul>
          ...
          <p>전화번호 : 02 - 6956 - 0053</p>

          <p>이메일 : admin@pesade.kr</p>
