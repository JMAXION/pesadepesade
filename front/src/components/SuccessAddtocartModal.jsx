...
export default function SuccessAddtocartModal({
  closeModal,
  prop,
  tp,
  choice,
      ...
      >
        <div className="modal-content">
          ...
          <ul className="image-list">
            {" "}
            {/* 가로로 2개씩 나열할 이미지들을 감싸는 ul 요소 */}
            {getCurrentItems().map((obj) => (
              <li key={obj.pid}>
                <img
                  className="cart-modal-result-img"
          ...
          <div className="button-group">
            <button className="modal-keep-shopping" onClick={handleCloseModal}>
              계속 쇼핑하기
            </button>
            <Link to="/cart">
